...
Every ERC-721C collection that wants full GONDI support needs to whitelist all seven contracts below. Partial whitelisting is possible, but flows that rely on a non-whitelisted contract will revert.

* **MultiSourceLoan 3.2:** `0xE365fF3cad44d19cb7aBa81df8ffd6818A66Ac0a` — starting and repaying loans
* **MultiSourceLoan 3.1:** `0xf41B389E0C1950dc0B16C9498eaE77131CC08A56` — repaying legacy 3.1 loans
* **MultiSourceLoan 3.0:** `0xf65b99ce6dc5f6c556172bcc0ff27d3665a7d9a8` — repaying legacy 3.0 loans
* **PurchaseBundler 3.2 (cross-currency):** `0x2B5E66c44B223b9D3B192e697F58795febCd6C10` — buy-with-loan and sell-and-repay
...
* Add each of the seven addresses above to your collection's operator allowlist
* Confirm the collection's security level consults the operator allowlist

## Verifying

* Read the operator allowlist and confirm all seven addresses are present
